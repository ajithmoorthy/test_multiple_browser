package com.atmecs.csslocators.constants;
/**
...
public class FileConstants {
	...
	public static final String CONFIG1_PATH = "./config2.properties";
	...
	public static final String LOCATOR1_PATH ="./src/test/resources/locators/locators.properties";
